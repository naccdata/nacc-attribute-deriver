...
class UDSFormB8Missingness(UDSMissingness):
    ...
    def _handle_normnrexam_gate(self, field: str) -> int:
    ...
    def _handle_normexam_gate(self, field: str) -> int:
        """V3 and earlier only.
    ...
    def _missingness_parksign(self) -> int:
    ...
    def _handle_normnrexam_with_gate(self, gate: str, field: str) -> int:
    ...
    def _handle_normexam_with_gate(self, gate: str, field: str) -> int:
    ...
    def _missingness_othneur(self) -> int:
