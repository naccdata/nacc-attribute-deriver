...
class UDSFormA4aMissingness(VersionedUDSMissingness):
    ...
    def _handle_fvp_gate(self, gate: str, field: str) -> Optional[int]:
        ...
        If NEWTREAT = 0 or 9, all subsequent variables Q.2a1a-3b3a should be autofilled to prior visit
        If NEWADEVENT = 0 or 9, all  subsequent variables Q.3b1-3b3a should be autofilled to prior visit
        """
