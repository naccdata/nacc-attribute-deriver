...
class UDSFormA4aMissingness(UDSMissingness):
    def _handle_fvp_gate(self, gate: str, field: str) -> int:
    ...
    def _handle_a4a_missingness(
        ...
        fvp_gates: List[str],
        field: str,
        attr_type: Type[int] | Type[str] = int,
    ) -> Any:
            ...
            for gate in fvp_gates:
                ...
                if gate in ["newtreat", "newadevent"]:
                    if gate_value in [0, 9]:
                        prev_value = self.get_prev_value(field, attr_type)
