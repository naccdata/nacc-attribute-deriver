...
class UDSFormC1Attribute(AttributeCollection):
    ...
    def __init__(self, table: SymbolTable):
        self.uds = UDSNamespace(table)
        self.formver = self.uds.normalized_formver()
    ...
    def __calculate_interval_from_a1(self, cmp_date: str) -> Optional[int]:
        ...
        frmdate_a1 = datetime_from_form_date(
            self.uds.get_value("frmdatea1", str))
    ...
    def _create_naccc2(self) -> Optional[int]:
        """Creates NACCC2, form data discrepancy between UDS Form A1
        and Form C2.
        """
        if self.__frmdatec2 is None:
            return None

        freturn self.__calculate_interval_from_a1(self.__frmdatec2)
