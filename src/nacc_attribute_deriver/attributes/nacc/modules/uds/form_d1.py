...
class UDSFormD1Attribute(UDSAttribute):
    ...
    def __init__(self, *args, **kwargs) -> None:
        """Initializer - mainly extracts normcog and formver
        beforehand as they are used for most derived variables.
        """
        super().__init__(*args, **kwargs)

        self.__normcog = self.get_value('normcog')
        self.__formver = self.get_value('formver')
    ...
    def _create_naccetpr(self) -> int:
        ...
        all_status = [
            ...
            self.get_contr_status(['dlbif', 'parkif', 'lbdif']) if self.__formver != 3 else None,
    ...
    def _create_naccppa(self) -> int:
        ...
        if self.get_value('impnomci') == 1 or self._create_mci() == 1:
            ...
            if ppaph == 0 or ppasyn == 0:
                return 0
            if (self.__formver != 3 and nodx == 1) or (self.__formver == 3):
                return 7
    ...
    def _create_naccnorm(self) -> int:
        ...
        if not naccnorm or self.__normcog == 0:
            return 0
