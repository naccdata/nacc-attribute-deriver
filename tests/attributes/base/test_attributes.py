...
from nacc_attribute_deriver.attributes.base.base_attribute import BaseAttribute
...
class TestAttribute:
    def test_get_value(self):
        ...
        attr = BaseAttribute(table, attribute_prefix="test.")
    ...
    def test_assert_required(self):
        ...
        attr = BaseAttribute(table, "file.info.forms.json.")
